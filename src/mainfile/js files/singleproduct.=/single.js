...
function SingleItem() {
    ...
    useEffect(() => {
        ...
        setId(params.get("id"))
        let a = data[params.get("q")].find((val) => val.id == params.get("id"))
   ...
   const dispatch = useDispatch()
    ...
    return (
        <><NavScrollExample/>
            ...
            <div className="row single-main">
                <div className="col-lg-6 col-sm-12 single-img">
                    <img
                        src={Boolean(product) && product.img}
                        alt="product img"
                    />
                </div>
                <div className="col-lg-6 col-sm-12 product-detail">

                    <p className="product-name">{Boolean(product) && product.productName}</p>

                    <p>A dress (also known as a frock or a gown) is a garment traditionally worn by women or girls consisting of a skirt with an attached bodice (or a matching bodice giving the effect of a one-piece garment). It consists of a top piece that covers the torso and hangs down over the legs.{Boolean(product) && product.description}</p>
                    <h2 className="product-price">₹  {Boolean(product) && product.Price}</h2>
                    <h4>Available offers</h4>
                    <div className="product-offer">
                    <p>
                        <img src="https://rukminim1.flixcart.com/www/36/36/promos/06/09/2016/c22c9fc4-0555-4460-8401-bf5c28d7ba29.png?q=90"></img>Bank Offer5% Cashback on Flipkart Axis Bank CardT&C </p>
                    <p><img src="https://rukminim1.flixcart.com/www/36/36/promos/06/09/2016/c22c9fc4-0555-4460-8401-bf5c28d7ba29.png?q=90"></img>Buy this Product and Get Extra ₹500 Off on Two-Wheelers</p>
                    <p><img src="https://rukminim1.flixcart.com/www/36/36/promos/06/09/2016/c22c9fc4-0555-4460-8401-bf5c28d7ba29.png?q=90"></img>Partner OfferSign up for Flipkart Pay Later anp Gift Card worth up to ₹500*Know More </p>
                    <p><img src="https://rukminim1.flixcart.com/www/36/36/promos/06/09/2016/c22c9fc4-0555-4460-8401-bf5c28d7ba29.png?q=90"></img>Combo OfferBuy 3 items save 3%; Buy 4 save 4%; Buy 5+ save 5%See all productsT&C </p>
                    </div>
                    <div>
                        <button>Buy</button>
